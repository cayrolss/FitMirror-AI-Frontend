                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await UpdateUserProfileCall.call(
                                        ...
                                        goal: FFAppState().userGoal,
                                        gender: FFAppState().userGender,
                                        age: FFAppState().userAge,
                                        heightCm: FFAppState().userHeight,
                                        weightKg: FFAppState().userWeight,
                                        workoutPlace:
                                            FFAppState().userWorkoutPlace,
                                        exerciseFrequency:
                                            FFAppState().userExcerciseFrequency,
                                        goalWeightKg:
                                            FFAppState().userGoalWeight,
                                        weightChangeSpeed:
                                            FFAppState().userSpeed,
                                        muscleGroupFocusList:
                                            FFAppState().muscleGroupList,
                                        weeklyTrainings:
                                            FFAppState().userExcerciseFrequency,
                                        cardioType: FFAppState().userCardio,
                                        cardioFrequency:
                                            FFAppState().userExcerciseFrequency,
                                        allergiesList: FFAppState().allergies,
                                        dietaryType: FFAppState().userDietType,
                                        dietFocus: FFAppState().userDietType,
                                        mealsPerDay: FFAppState().mealsPerDay,
                                        dislikedFoodsList:
                                            FFAppState().dislikedFoods,
                                        likedFoodsList: FFAppState().likedFoods,
                                        dietaryRestrictionsList:
                                            FFAppState().allergies,
                                        preferredExercisesList:
                                            FFAppState().muscleGroupList,
                                        dislikedExercisesList:
                                            FFAppState().muscleGroupList,
                                        injuriesList:
                                            FFAppState().muscleGroupList,
                                      );
                                      ...
                                      context.pushNamedAuth(
                                        HomePageTrainingWidget.routeName,
                                        context.mounted,
