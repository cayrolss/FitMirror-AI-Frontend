...
import 'z_equipment_b_s_model.dart';
export 'z_equipment_b_s_model.dart';

class ZEquipmentBSWidget extends StatefulWidget {
  const ZEquipmentBSWidget({super.key});

  @override
  State<ZEquipmentBSWidget> createState() => _ZEquipmentBSWidgetState();
}

class _ZEquipmentBSWidgetState extends State<ZEquipmentBSWidget> {
  late ZEquipmentBSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZEquipmentBSModel());
  }
