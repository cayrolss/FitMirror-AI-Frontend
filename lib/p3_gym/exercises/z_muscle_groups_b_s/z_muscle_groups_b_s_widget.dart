...
import 'z_muscle_groups_b_s_model.dart';
export 'z_muscle_groups_b_s_model.dart';

class ZMuscleGroupsBSWidget extends StatefulWidget {
  const ZMuscleGroupsBSWidget({super.key});

  @override
  State<ZMuscleGroupsBSWidget> createState() => _ZMuscleGroupsBSWidgetState();
}

class _ZMuscleGroupsBSWidgetState extends State<ZMuscleGroupsBSWidget> {
  late ZMuscleGroupsBSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZMuscleGroupsBSModel());
  }
